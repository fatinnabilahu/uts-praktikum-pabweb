<?php include('config2.php'); ?>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['id'])){
			...
			//query ke database SELECT tabel beasiswa_nasional berdasarkan id = $id
			$select = mysqli_query($koneksi, "SELECT * FROM beasiswa_nasional WHERE id='$id'") or die(mysqli_error($koneksi));
